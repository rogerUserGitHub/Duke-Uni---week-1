...
public class PerimeterAssignmentRunner {
    ...
    public double getAverageLength(Shape s) {
        double lenghtAllSides = getPerimeter(s);
        double numberPoints = (double) getNumPoints(s);
        
        double averageLenght = lenghtAllSides / numberPoints; 
